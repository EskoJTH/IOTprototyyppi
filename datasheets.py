...
# inside the 'client_email' setting in the SpreadsheetData-*.jting the spreadsheet will work.
# Go to your spreadsheet in Google Spreadsheet and share it to the email address
...
GDOCS_OAUTH_JSON       = 'ProjectPiTempHum-17c7acdd1340.json'

# Google Docs spreadsheet name.
GDOCS_SPREADSHEET_NAME = 'TemperatureHumidity'
